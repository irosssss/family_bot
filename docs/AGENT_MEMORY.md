...
- Следующий пакет — ограниченный этап3.1 `STAGE_3_CARD.md`: V3 foundation/capabilities, fixture identity, синтетическая отдельная БД;20будущих проверок. Потом операции по подэтапам. Графика5, сезон6, платежи7. Основной прежний контракт ниже остаётся историей исходного варианта; его решения не мигрировать автоматически.
