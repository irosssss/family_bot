...
- Следующий пакет: этап 2 «Контракт V3 v0.1 и баланс», подробный план `docs/v3/STAGED_PLAN.md`. Сначала конкретные правила взрослых/детей/времени/долей, маленький каталог расходов и симуляция; затем серверные операции этапа 3. Графика — 5, сезон — 6, платежи — 7. Основной прежний контракт ниже остаётся историей исходного варианта; его решения не мигрировать автоматически.
