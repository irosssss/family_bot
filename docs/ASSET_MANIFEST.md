> С 22.09.2026 в public остаются только 36 ресурсов каталога content-source/v3/assets.json. Записи о прежних ассетах ниже — история происхождения, не список файлов текущей сборки.

# ASSET MANIFEST — Family Chores RPG

## Подготовленные папки V3 — 2026-09-09

В изолированной ветке V3 создан `public/assets/game/family_life_v3/v1/` с пустыми подкаталогами (`.gitkeep`). **Игровых изображений V3: 0**, подключённых файлов: 0. Это структура поставки, а не строки готовых ассетов с выдуманным Size. Фактические Name/Size/Path/Used-by добавляются при приёмке PNG по [контракту V3](v3/ASSET_DELIVERY.md). Исходники/кандидаты находятся вне public: `art/family-life-v3/`. Ниже сохранён manifest прежнего проекта.
