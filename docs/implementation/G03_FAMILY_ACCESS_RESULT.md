...
Версия 1.0, 2026-09-07. **Разрешён ответом «да». G3D01–G3D06 реализованы и проверены в указанных ниже границах; принят пользователем перед G03-E.** Основа — [карточка G03-D](G03_FAMILY_ACCESS_CARD.md). Следующий блок [G03-E](G03_ADULT_PROTECTION_RESULT.md) затем разрешён и выполнен. Ниже сохранён результат на момент G03-D.
