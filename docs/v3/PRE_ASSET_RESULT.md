...
> Обновление: [повторный аудит](REAUDIT_RESULT.md) нашёл и исправил ошибки общей cookie между вкладками, привязки завершённой цели и устаревших UI-состояний. Текущие проверки: 36 UI/model +225 server/PG. Числа ниже сохраняют историю первоначального прогона;84/26 в пункте5 связано с исправленным дефектом.
