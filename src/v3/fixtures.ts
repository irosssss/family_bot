...
export type Member = { id: string; name: string; familyRole: 'adult' | 'child'; permissions: { manageFamily: boolean; reviewChildTasks: boolean }; hero: { xp: number; title: string } };
...
const member = (id: string, name: string, familyRole: Member['familyRole'], title: string): Member => ({ id, name, familyRole, permissions: { manageFamily: familyRole === 'adult', reviewChildTasks: familyRole === 'adult' }, hero: { xp: 35, title } });
...
export const demoTasks: Task[] = [
  { id: 'read', title: 'Почитать любимую книгу', description: 'Выбери историю и почитай 15 минут. После можно рассказать семье, что понравилось.', assignee: 'sasha', category: 'learning', difficulty: 'normal', status: 'ready', requiresReview: true, rewardLabel: 'Опыт героя, золото и вклад в общую цель' },
  { id: 'plants', title: 'Полить комнатные растения', description: 'Проверь землю и полей те цветы, которым нужна вода.', assignee: 'irina', category: 'home', difficulty: 'easy', status: 'ready', requiresReview: false, rewardLabel: 'Опыт героя, золото и вклад в общую цель' },
  { id: 'walk', title: 'Выйти на прогулку', description: 'Небольшая прогулка в удобном темпе. Задание можно перенести без штрафа.', assignee: 'alex', category: 'care', difficulty: 'normal', status: 'done', requiresReview: false, rewardLabel: 'Опыт героя, золото и вклад в общую цель' },
  ...
  { id: 'dinner', title: 'Подготовить стол к ужину', description: 'Каждый берёт посильную часть: салфетки, тарелки или воду. Вклады участников принимаются отдельно.', assignee: 'family', category: 'together', difficulty: 'easy', status: 'ready', requiresReview: true, rewardLabel: 'Общий результат, отдельный вклад каждого', shares: [
